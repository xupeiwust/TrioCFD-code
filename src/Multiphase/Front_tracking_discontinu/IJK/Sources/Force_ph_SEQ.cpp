...
// #include <math.h>
// #include <fftw3.h>
// #include <IJK_Navier_Stokes_tools.h> // Pour allocate_velocity au
...
//  //             voir IJK_FT_post.
// allocate_velocity(force_, splitting, 2); //: pourquoi 2 a la fin ?
//
//  ///////////////////////////////////////////////////////////////
...
//
//
// void Force_ph::from_spect_to_phys(const std::vector< std::vector< std:: vector <double >>>& coeff_force)
// {
//   //////////////////////////////////////////////////////////////////////////////
//   /*
//   Version la plus primitive de la transformée de Fourier inverse :
//        - 6 boucles imbriquées (3 d'espace physique, 3 d'espace spectral).
//        - coefficients de la force spectrale stockés dans un tableau
//          à trois dimensions.
...
//                   {
//                     int ind_ijk = (k*nj +j)*ni + i;
//                     force[0][dir][ind_ijk] = 0.0;
//                     force[1][dir][ind_ijk] = 0.0;
//                   }
//               }
//         }
//       }
...
//   int n_dir = 3;
//
//   std::cout<<"nproc_tot : "<<nproc_tot<<std::endl;
//
//   //////////////////////////////////////////////////////////////
//   // TODO : remplacer mes pos[X] par un résultat de build_local_coords
...
//                               int ind_CDImni((1*n_dir+dir)*n_ind_mni+ind_mni);
//
//                               bout_a_quart[ind_RDImni] += 1*(coeff_force[0][dir][ind_lmn]*expo_a[0] - coeff_force[1][dir][ind_lmn]*expo_a[1]);
//                               bout_a_quart[ind_CDImni] += 1*(coeff_force[0][dir][ind_lmn]*expo_a[1] + coeff_force[1][dir][ind_lmn]*expo_a[0]);
//                             }
//                           }
...
//   //////////////////////////////////////////////////////////////////////////////
//   /*
//   Version primitive de la transformée de Fourier inverse :
//        - 6 boucles imbriquées (3 d'espace physique, 3 d'espace spectral).
//        - coefficients de la force spectrale stockés dans un tableau
...
//
//
// void Force_ph::from_spect_to_phys_opti(const std::vector< std::vector< std:: vector <double >>>& coeff_force)
// {
//   //////////////////////////////////////////////////////////////////////////////
//   /*
//   Version avancée de la transformée de Fourier inverse :
//        - Les 6 boucles imbriquées sont éclatées en 3 blocs de complexité
//          au plus ni*nj*nk*nn.
//          - coefficients de la force spectrale stockés dans un tableau
//            à trois dimensions.
//          - coefficients de la force physique recopiés dans un tableau
...
//   int n_dir(3);
//   double dz(Lz/nk), dy(Ly/nj), dx(Lx/ni);
//   int n_ind_mni((2*nm+1)*(2*nn+1)*1*ni);
//   int n_ind_nij((2*nn+1)*1*ni*1*nj);
//
//   std:: vector <double > bout_a_quart(2*3*n_ind_mni,0.);
//   std:: vector <double > bout_b_quart(2*3*n_ind_nij,0.);
//
...
//
//
// void Force_ph::from_spect_to_phys_opti2(const std:: vector <double >& coeff_force)
// {
//   //////////////////////////////////////////////////////////////////////////////
//   /*
//   Version la plus avancée de la transformée de Fourier inverse :
//        - Les 6 boucles imbriquées sont éclatées en 3 blocs de complexité
//          au plus ni*nj*nk*nn.
//        - coefficients de la force spectrale stockés dans un tableau
//          à une dimension, on reconstruit l'indice à aller chercher.
