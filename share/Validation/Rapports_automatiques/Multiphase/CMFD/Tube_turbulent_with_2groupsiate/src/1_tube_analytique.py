...
if __name__ == "__main__":
    build_mesh(2.0, "/volatile2/catA/triocfd-code/share/Validation/Rapports_automatiques/Multiphase/CMFD/Tube_turbulent_with_2groupsiate/src", "1_tube_analytique.med")
